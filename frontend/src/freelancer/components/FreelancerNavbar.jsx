...
import { 
  FaHome, FaBriefcase, FaSearch, FaList, FaUserCircle, 
  ...
  return (
    ...
    >
      <Container fluid className="px-4 px-lg-5">
        ...
        {/* LOGO */}
        <BSNavbar.Brand as={Link} to="/freelancer/dashboard" className="fw-bold me-4">
        ...
        <BSNavbar.Toggle aria-controls="freelancer-navbar" style={{ borderColor: colors.text }} />
        
        <BSNavbar.Collapse id="freelancer-navbar">
          
          {/* NAVIGATION LINKS */}
          <Nav className="mx-auto align-items-center gap-lg-4">
            <Nav.Link as={Link} to="/freelancer/dashboard" className="d-flex align-items-center" style={{ color: colors.text, transition: '0.3s' }}>
            ...
            <Nav.Link as={Link} to="/freelancer/my-services" className="d-flex align-items-center" style={{ color: colors.text, transition: '0.3s' }}>
              <FaList className="me-2" style={{ color: colors.accent }} /> My Services
            </Nav.Link>
          </Nav>
          ...
          <Dropdown align="end">
            ...
            <Dropdown.Menu className="shadow-lg border-0 mt-2" style={{ borderRadius: '12px', minWidth: '220px' }}>
              ...
              {/* THEME TOGGLE - YAHAN SE CONTROL HOGA */}
              ...
              <Dropdown.Item as={Link} to="/freelancer/profile" className="py-2" style={{ color: '#082c5e' }}>
